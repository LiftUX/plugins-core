...
/**
 * Trait: Integration_Decorator
 *
 * Provides methods to implement the Integration Interface and Subscriber Interface.
 *
 * @since  v0.1.0
...
trait Integration_Decorator {
	 ...
	 *
	 * When called from a parent class using this trait, decorates the class with a hook_catalog property.
	 *
	 * @param Hook_Catalog     $hook_catalog Hook Catalog.
	 * @param array|Provider[] ...$providers Array of providers.
	 * @return Integration                   Instance of self.
	 */
	public function decorate_integration( Hook_Catalog $hook_catalog, Provider ...$providers ) : Integration {
		$this->hook_catalog = $hook_catalog;
		return $this;
	}
